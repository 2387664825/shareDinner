...
// 管理员列表
export const adminList = data => fetch(front + '/admin/list', data);
...
// 获取家庭列表
export const getResturants = data => fetch(front + '/family', data);

// 获取餐馆详细信息
export const getResturantDetail = restaurant_id => fetch('/shopping/restaurant/' + restaurant_id);

// 获取家庭数量
export const getResturantsCount = () => fetch(front + '/family/count');
...
// 获取食品列表
export const getFoods = data => fetch(front + '/food/list', data);
...
// 获取用户列表
export const getUserList = data => fetch(front + '/user/list', data);

// 获取用户数量
export const getUserCount = data => fetch('/v1/users/count', data);

// 获取订单列表
export const getOrderList = data => fetch(front + '/order', data);
